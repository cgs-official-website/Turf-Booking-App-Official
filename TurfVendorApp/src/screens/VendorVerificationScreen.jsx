  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <Text style={styles.stepLabel}>Step 2 out of 3</Text>
        ...
        <Text style={[styles.title, { color: colors.text }]}>Vendor verification</Text>
        ...
        <UploadBox label="PAN Card" file={panFile} onPress={() => pickFile(setPanFile)} />
...
const getStyles = (colors) => StyleSheet.create({
  ...
  stepLabel: { fontSize: 12, color: colors.textSecondary, marginBottom: 16 },
